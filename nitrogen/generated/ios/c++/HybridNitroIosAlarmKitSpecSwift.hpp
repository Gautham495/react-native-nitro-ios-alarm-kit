...
namespace margelo::nitro::nitroiosalarmkit {
  ...
  public:
    ...
    inline std::shared_ptr<Promise<std::optional<std::string>>> scheduleAlarm(const std::string& title, const CustomizableAlarmButton& stopBtn, const std::string& tintColor, const std::optional<CustomizableAlarmButton>& secondaryBtn, std::optional<double> timestamp, const std::optional<AlarmCountdown>& countdown, const std::optional<std::string>& soundName) override {
    ...
    inline std::shared_ptr<Promise<std::optional<std::string>>> scheduleAutoStopAlarm(const std::string& title, const CustomizableAlarmButton& stopBtn, const std::string& tintColor, double ringCount, std::optional<double> ringDurationSeconds, const std::optional<CustomizableAlarmButton>& secondaryBtn, std::optional<double> timestamp, const std::optional<AlarmCountdown>& countdown, const std::optional<std::string>& soundName) override {
