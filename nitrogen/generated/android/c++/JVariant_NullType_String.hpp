...
namespace margelo::nitro::nitroiosalarmkit {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/nitroiosalarmkit/Variant_NullType_String;";
  ...
  namespace JVariant_NullType_String_impl {
    ...
    public:
      static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/nitroiosalarmkit/Variant_NullType_String$First;";
    ...
    public:
      static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/nitroiosalarmkit/Variant_NullType_String$Second;";
