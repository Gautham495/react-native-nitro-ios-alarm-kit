...
namespace margelo::nitro::nitroiosalarmkit {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/nitroiosalarmkit/AlarmCountdown;";
  ...
  public:
    ...
    static jni::local_ref<JAlarmCountdown::javaobject> fromCpp(const AlarmCountdown& value) {
      using JSignature = JAlarmCountdown(jni::alias_ref<jni::JDouble>, jni::alias_ref<jni::JDouble>);
      static const auto clazz = javaClassStatic();
