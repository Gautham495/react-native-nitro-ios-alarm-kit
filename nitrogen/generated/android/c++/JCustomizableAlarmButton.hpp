...
namespace margelo::nitro::nitroiosalarmkit {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/nitroiosalarmkit/CustomizableAlarmButton;";
  ...
  public:
    ...
    static jni::local_ref<JCustomizableAlarmButton::javaobject> fromCpp(const CustomizableAlarmButton& value) {
      using JSignature = JCustomizableAlarmButton(jni::alias_ref<jni::JString>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JString>);
      static const auto clazz = javaClassStatic();
