...
namespace margelo::nitro::nitroiosalarmkit {
  ...
  class HybridNitroIosAlarmKitSpec: public virtual HybridObject {
    ...
    public:
      ...
      virtual std::shared_ptr<Promise<std::string>> scheduleAutoStopAlarm(const std::string& title, const CustomizableAlarmButton& stopBtn, const std::string& tintColor, double ringCount, double ringDurationSeconds, const std::optional<CustomizableAlarmButton>& secondaryBtn, std::optional<double> timestamp, const std::optional<AlarmCountdown>& countdown, const std::optional<std::string>& soundName) = 0;
